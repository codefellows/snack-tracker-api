"""
Django settings for snack_tracker_api_project project.
...
ROOT_URLCONF = 'snack_tracker_api_project.urls'
...
WSGI_APPLICATION = 'snack_tracker_api_project.wsgi.application'
